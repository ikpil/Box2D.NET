...
public class BenchmarkManyTumblers : Sample
{
    ...
    public BenchmarkManyTumblers(SampleAppContext ctx, Settings settings) : base(ctx, settings)
    {
        ...
        {
            m_context.g_camera.m_center = new B2Vec2(1.0f, -5.5f);
            m_context.g_camera.m_zoom = 25.0f * 3.4f;
        ...
        m_rowCount = B2.g_sampleDebug ? 2 : 19;
        m_columnCount = B2.g_sampleDebug ? 2 : 19;
    ...
    void CreateScene()
    {
        ...
        int bodiesPerTumbler = B2.g_sampleDebug ? 8 : 50;
