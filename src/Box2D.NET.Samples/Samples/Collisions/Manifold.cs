...
public class Manifold : Sample
{
        ...
        : base(settings)
    {
        ...
        {
            // B2.g_camera.m_center = {1.8f, 15.0f};
            B2.g_camera.m_center = new B2Vec2(1.8f, 0.0f);
    ...
    void DrawManifold(ref B2Manifold manifold, B2Vec2 origin1, B2Vec2 origin2)
    {
        for (int i = 0; i < manifold.pointCount; ++i)
        {
            ...
            if (m_showAnchors)
            {
                B2.g_draw.DrawPoint(b2Add(origin1, mp.anchorA), 5.0f, B2HexColor.b2_colorRed);
                B2.g_draw.DrawPoint(b2Add(origin2, mp.anchorB), 5.0f, B2HexColor.b2_colorGreen);
            }
            else
            {
                B2.g_draw.DrawPoint(p1, 10.0f, B2HexColor.b2_colorBlue);
            }
    ...
    public override void Step(Settings settings)
    {
        ...
        // circle-circle
        {
            ...
            B2.g_draw.DrawSolidCircle(ref transform1, circle1.center, circle1.radius, color1);
            B2.g_draw.DrawSolidCircle(ref transform2, circle2.center, circle2.radius, color2);
        ...
        // capsule-circle
        {
            ...
            B2.g_draw.DrawSolidCapsule(v1, v2, capsule.radius, color1);
        ...
        // capsule-capsule
        {
            ...
            B2.g_draw.DrawSolidCapsule(v1, v2, capsule1.radius, color1);

            v1 = b2TransformPoint(ref transform2, capsule2.center1);
            v2 = b2TransformPoint(ref transform2, capsule2.center2);
            B2.g_draw.DrawSolidCapsule(v1, v2, capsule2.radius, color2);
        ...
        // box-capsule
        {
            ...
            B2.g_draw.DrawSolidCapsule(v1, v2, capsule.radius, color2);
        ...
        // segment-capsule
        {
            ...
            B2.g_draw.DrawSolidCapsule(p1, p2, capsule.radius, color2);
        ...
        // chain-segment vs circle
        {
            ...
            B2.g_draw.DrawSegment(g1, p1, B2HexColor.b2_colorLightGray);
            B2.g_draw.DrawSegment(p1, p2, color1);
            B2.g_draw.DrawSegment(p2, g2, B2HexColor.b2_colorLightGray);
            B2.g_draw.DrawSolidCircle(ref transform2, circle.center, circle.radius, color2);
        ...
        // chain-segment vs rounded polygon
        {
...

            {
                ...
                B2.g_draw.DrawSegment(p1, p2, color1);
                B2.g_draw.DrawPoint(p1, 4.0f, color1);
        ...
        // chain-segment vs capsule
        {
...

            {
                ...
                B2.g_draw.DrawPoint(b2Lerp(p1, p2, 0.5f), 5.0f, B2HexColor.b2_colorGainsboro);
            }
