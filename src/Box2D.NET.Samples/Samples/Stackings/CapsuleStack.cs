...
public class CapsuleStack : Sample
{
    ...
    {
        return new CapsuleStack(ctx, settings);
    }

    public CapsuleStack(SampleAppContext ctx, Settings settings) : base(ctx, settings)
    {
...

        {
            ...
            b2CreatePolygonShape(groundId, ref shapeDef, ref polygon);
        }
