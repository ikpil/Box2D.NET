...
public static class FontsV1
{
    ...
    public static FontV1 CreateFont(GL gl, string trueTypeFile, float fontSize)
    {
        FontV1 font = new FontV1();
    ...
    public static void DestroyFont(GL gl, ref FontV1 font)
    {
        if (font.programId != 0)
        {
    ...
    public static void AddText(ref FontV1 font, float x, float y, B2HexColor color, string text)
    {
        if (text == null)
        {
            return;
    ...
    public static void FlushText(GL gl, ref FontV1 font, Camera camera)
    {
